# List of Competitive Porgramming Algorithms implemented in C++
...
:white_check_mark:  Bellman-Ford - finding shortest paths with negative weights

:white_check_mark:  0-1 BFS

:white_check_mark:  D´Esopo-Pape algorithm

### All-pairs shortest paths
:white_check_mark:  Floyd-Warshall - finding all shortest paths

:white_check_mark:  Number of paths of fixed length / Shortest paths of fixed length

### Spanning trees
:white_check_mark:  Minimum Spanning Tree - Prim's Algorithm

:white_check_mark:  Minimum Spanning Tree - Kruskal

:white_check_mark:  Minimum Spanning Tree - Kruskal with Disjoint Set Union

:white_check_mark:  Second best Minimum Spanning Tree - Using Kruskal and Lowest Common Ancestor

:white_check_mark:  Kirchhoff Theorem

:white_check_mark:  Prüfer code

### Cycles
:white_check_mark:  Checking a graph for acyclicity and finding a cycle in O(M)

:white_check_mark:  Finding a Negative Cycle in the Graph

:white_check_mark:  Eulerian Path

### Lowest common ancestor
:white_check_mark:  Lowest Common Ancestor

:white_check_mark:  Lowest Common Ancestor - Binary Lifting

:white_check_mark:  Lowest Common Ancestor - Farach-Colton and Bender algorithm

:white_check_mark:  Solve RMQ by finding LCA

:white_check_mark:  Lowest Common Ancestor - Tarjan's off-line algorithm

### Flows and related problems
:white_check_mark:  Maximum flow - Ford-Fulkerson and Edmonds-Karp

:white_check_mark:  Maximum flow - Push-relabel algorithm

:white_check_mark:  Maximum flow - Push-relabel algorithm improved

:white_check_mark:  Maximum flow - Dinic's algorithm

:white_check_mark:  Maximum flow - MPM algorithm

:white_check_mark:  Flows with demands

:white_check_mark:  Minimum-cost flow

:white_check_mark:  Assignment problem. Solution using min-cost-flow in O (N^5)

### Matchings and related problems
:white_check_mark:  Bipartite Graph Check

:white_check_mark:  Kuhn' Algorithm - Maximum Bipartite Matching

### Miscellaneous
:white_check_mark:  Topological Sorting

:white_check_mark:  Edge connectivity / Vertex connectivity

:white_check_mark:  Tree painting

:white_check_mark:  2-SAT

:white_check_mark:  Heavy-light decomposition
...
### Sequences
:white_check_mark:  RMQ task (Range Minimum Query - the smallest element in an interval)

:white_check_mark:  Longest increasing subsequence

:white_check_mark:  Search the subsegment with the maximum/minimum sum

:white_check_mark:  K-th order statistic in O(N)

:white_check_mark:  Game Theory

:white_check_mark:  Games on arbitrary graphs

:white_check_mark:  Sprague-Grundy theorem. Nim

### Schedules
:white_check_mark:  Scheduling jobs on one machine

:white_check_mark:  Scheduling jobs on two machines

:white_check_mark:  Optimal schedule of jobs given their deadlines and durations
